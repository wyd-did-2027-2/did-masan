...
export const content = {
  kr: {
    lang: "ko",
    metadata: {
      title: "WYD SEOUL 2027 DID 마산",
      description: "WYD SEOUL 2027 DID 마산 공식 웹사이트",
      ogLocale: "ko_KR",
    },
    header: {
  ...
  en: {
    lang: "en",
    metadata: {
      title: "WYD SEOUL 2027 DID Masan",
      description: "WYD SEOUL 2027 DID Masan Official Website",
      ogLocale: "en_US",
    },
    header: {
